...
// Fail fast if critical secrets are missing — never run auth with an unset secret
...
import behaviorRequestsRouter from "./routes/behaviorRequests.js";
...
app.use("/qr", qrRouter);
app.use("/behavior-requests", behaviorRequestsRouter);
